...
def index():
    ...
    return render_template('bot.html', ollama_status=ollama_status)
...
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║        🌐 IncognitoAI – Privacy Edition | H9 🌐                  ║
║                                                                  ║
║            Flask-based Offline AI Assistant                      ║
║        Zero Tracking • Fully Local • No Cloud                    ║
║                                                                  ║
║              Developed by: H9 & VaradScript                      ║
║                                                                  ║
╚══════════════════════════════════════════════════════════════════╝
